...
namespace MMM.Repository.Mocks
{
    public class AccountRead
    {
        ...
        private void ConfigureMock()
        {
            ...
            {
                new Account{Id = 1, Name = "Test 1 zobaczmy jak", Balance = 1302.31M, Currency = (int)CurrencyFormat.PLN, User = new User{FirstName = "Janusz", LastName = "Testowy"}, Transactions = new List<Transaction>() {new Transaction() {Id = 1, Name = "Testowa transakcja 1",AccountBalance = 500M, Amount = 32.50M, Created = DateTime.Now}}},
